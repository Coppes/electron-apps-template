...
Optional error tracking and crash reporting service integration for production monitoring and debugging.
...
- **logging**: Crash reports are always logged locally regardless of remote reporting
- **auto-updater**: Update failures can be reported for monitoring
