...
Unified logging system accessible from both main and renderer processes, writing to a single log file with structured metadata.
...
None - This is a new capability building on existing `logger.js` infrastructure.

## Related Capabilities

- **auto-updater**: Uses logging system for update event tracking
- **crash-reporting**: Crash reports can include recent log entries for context
