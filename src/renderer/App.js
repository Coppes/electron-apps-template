...
function App() {
    ...
    return (_jsxs(ErrorBoundary, { children: [isPopout ? (_jsx(PopoutLayout, {})) : (_jsx(AppShell, { children: _jsx(TabContent, {}) })), _jsx(CommandPalette, {}), _jsx(Onboarding, {}), _jsx(WhatsNewModal, {}), _jsx(ConnectivityStatus, {}), updateStatus && (_jsx(UpdateNotification, { updateInfo: updateInfo, status: updateStatus, progress: updateProgress, onInstall: handleInstall, onDismiss: handleDismiss }))] }));
}
export default App;
